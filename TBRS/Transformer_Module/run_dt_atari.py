...
obss, actions, done_idxs, rtgs, timesteps = create_dataset(args.num_steps)
...
model = GPT(mconf)
# model.load_state_dict(torch.load('RT_minigrid'))
...
trainer.train()
# trainer.test()
torch.save(model.state_dict(), 'RT_minigrid_action3')
